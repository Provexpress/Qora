...
const toneMap: Record<string, string> = {
  ...
  "En operacion": "bg-sky-50 text-sky-700 border-sky-200",
  ...
  "Implementacion en curso": "bg-sky-50 text-sky-700 border-sky-200",
  ...
  "Ganado / Postventa": "bg-emerald-50 text-emerald-700 border-emerald-200",
